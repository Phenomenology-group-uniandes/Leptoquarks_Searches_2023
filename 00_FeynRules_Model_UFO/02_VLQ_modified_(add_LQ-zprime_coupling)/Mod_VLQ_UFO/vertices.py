...
V_118 = Vertex(name = 'V_118',
               ...
               couplings = {(0,0):C.GC_120,(0,1):C.GC_109})
...
V_121 = Vertex(name = 'V_121',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_119,(0,1):C.GC_108})
...
V_130 = Vertex(name = 'V_130',
               ...
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.VVV1, L.VVV2, L.VVV3, L.VVV4, L.VVV6, L.VVV7 ],
               couplings = {(0,0):C.GC_79,(0,1):C.GC_2,(0,2):C.GC_80,(0,3):C.GC_3,(0,4):C.GC_3,(0,5):C.GC_2})

V_131 = Vertex(name = 'V_131',
               particles = [ P.g, P.VLQ__tilde__, P.VLQ ],
               color = [ 'T(1,3,2)' ],
               lorentz = [ L.VVV1, L.VVV2, L.VVV3, L.VVV4, L.VVV6, L.VVV7 ],
               couplings = {(0,0):C.GC_75,(0,1):C.GC_14,(0,2):C.GC_76,(0,3):C.GC_15,(0,4):C.GC_15,(0,5):C.GC_14})

V_132 = Vertex(name = 'V_132',
               particles = [ P.a, P.a, P.VLQ__tilde__, P.VLQ ],
               color = [ 'Identity(3,4)' ],
               lorentz = [ L.VVVV1, L.VVVV2, L.VVVV4 ],
               couplings = {(0,0):C.GC_6,(0,1):C.GC_6,(0,2):C.GC_7})
...
V_134 = Vertex(name = 'V_134',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.VVV1, L.VVV2, L.VVV3, L.VVV4, L.VVV6, L.VVV7 ],
               couplings = {(0,0):C.GC_109,(0,1):C.GC_110,(0,2):C.GC_110,(0,3):C.GC_125,(0,4):C.GC_109,(0,5):C.GC_124})

V_135 = Vertex(name = 'V_135',
               particles = [ P.VLQ__tilde__, P.VLQ, P.Zp ],
               color = [ 'Identity(1,2)' ],
...
V_136 = Vertex(name = 'V_136',
               ...
               lorentz = [ L.VVVV1, L.VVVV2, L.VVVV4 ],
               couplings = {(0,0):C.GC_77,(1,0):C.GC_20,(0,1):C.GC_78,(2,1):C.GC_20,(2,2):C.GC_19,(1,2):C.GC_19})

V_137 = Vertex(name = 'V_137',
               particles = [ P.a, P.VLQ__tilde__, P.VLQ, P.Z ],
               color = [ 'Identity(2,3)' ],
               lorentz = [ L.VVVV1, L.VVVV2, L.VVVV4 ],
               couplings = {(0,0):C.GC_113,(0,1):C.GC_112,(0,2):C.GC_112})

V_138 = Vertex(name = 'V_138',
               particles = [ P.g, P.VLQ__tilde__, P.VLQ, P.Z ],
               color = [ 'T(1,3,2)' ],
               lorentz = [ L.VVVV1, L.VVVV2, L.VVVV4 ],
               couplings = {(0,0):C.GC_115,(0,1):C.GC_114,(0,2):C.GC_114})

V_139 = Vertex(name = 'V_139',
               particles = [ P.VLQ__tilde__, P.VLQ, P.Z, P.Z ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.VVVV1, L.VVVV2, L.VVVV4 ],
               couplings = {(0,0):C.GC_116,(0,1):C.GC_116,(0,2):C.GC_117})
...
V_161 = Vertex(name = 'V_161',
               ...
               color = [ 'f(1,2,3)' ],
               lorentz = [ L.VVV5, L.VVV9 ],
               couplings = {(0,0):C.GC_64,(0,1):C.GC_16})

V_162 = Vertex(name = 'V_162',
               particles = [ P.g, P.g, P.Gp, P.Gp ],
               color = [ 'f(-1,1,2)*f(3,4,-1)', 'f(-1,1,3)*f(2,4,-1)', 'f(-1,1,4)*f(2,3,-1)' ],
               lorentz = [ L.VVVV3, L.VVVV6, L.VVVV7 ],
               couplings = {(1,1):C.GC_20,(0,0):C.GC_65,(2,2):C.GC_20})

V_163 = Vertex(name = 'V_163',
               particles = [ P.g, P.g, P.g, P.Gp ],
               color = [ 'f(-1,1,2)*f(3,4,-1)', 'f(-1,1,3)*f(2,4,-1)', 'f(-1,1,4)*f(2,3,-1)' ],
               lorentz = [ L.VVVV3, L.VVVV6, L.VVVV7 ],
               couplings = {(1,1):C.GC_63,(0,0):C.GC_63,(2,2):C.GC_63})

V_164 = Vertex(name = 'V_164',
               particles = [ P.d__tilde__, P.d, P.Gp ],
               color = [ 'T(3,2,1)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_66,(0,1):C.GC_69})
...
V_167 = Vertex(name = 'V_167',
               ...
               color = [ 'T(3,2,1)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_44,(0,1):C.GC_72})
...
V_171 = Vertex(name = 'V_171',
               ...
               color = [ 'T(3,2,1)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_48,(0,1):C.GC_73})
...
V_175 = Vertex(name = 'V_175',
               ...
               color = [ 'T(3,2,1)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_52,(0,1):C.GC_74})

V_176 = Vertex(name = 'V_176',
               particles = [ P.mu__plus__, P.mu__minus__, P.Zp ],
               color = [ '1' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_146,(0,1):C.GC_156})
...
V_184 = Vertex(name = 'V_184',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_150,(0,1):C.GC_153})

V_185 = Vertex(name = 'V_185',
               particles = [ P.s__tilde__, P.s, P.Zp ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_151,(0,1):C.GC_154})

V_186 = Vertex(name = 'V_186',
               particles = [ P.b__tilde__, P.b, P.Zp ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_152,(0,1):C.GC_155})

V_187 = Vertex(name = 'V_187',
               particles = [ P.u__tilde__, P.u, P.Zp ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_53,(0,1):C.GC_158})
...
V_191 = Vertex(name = 'V_191',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_57,(0,1):C.GC_159})
...
V_195 = Vertex(name = 'V_195',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,0):C.GC_61,(0,1):C.GC_160})
