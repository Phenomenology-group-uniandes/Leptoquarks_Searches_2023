...
FFV3 = Lorentz(name="FFV3", spins=[2, 2, 3], structure="Gamma(3,2,-1)*ProjP(-1,1)")
...
VVV1 = Lorentz(
    name="VVV1", spins=[3, 3, 3], structure="P(3,1)*Metric(1,2) - P(2,1)*Metric(1,3)"
)

VVV2 = Lorentz(
    name="VVV2", spins=[3, 3, 3], structure="P(2,3)*Metric(1,3) - P(1,3)*Metric(2,3)"
)
